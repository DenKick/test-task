// * Компонент кнопки лайка, svg позаимствовал с сайта FreePik
<template>
...
export default {
  ...
  // * При создании элемента смотрим на то, есть ли он в массиве и выделяем, если есть
  // * Иначе не выделяем
  created() {
  ...
  methods: {
    ...
    clickHandler: function() {
      ...
      // * Создаём массив, если его не было
      if (likes === null) {
        likes = []
      }

      //  * Если лайк не поставлен, то мы записываем его в массив и выделяем кнопку
      //  * Иначе — находим индекс анекдота в массиве и удаляем лайк с анекдота
